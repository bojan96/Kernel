BUILD_DIR = build
SRC_DIR = src
OBJ = $(BUILD_DIR)/boot.o $(BUILD_DIR)/kernel.o $(BUILD_DIR)/irq.o $(BUILD_DIR)/irq_high_level.o $(BUILD_DIR)/isr_high_level.o $(BUILD_DIR)/isr.o $(BUILD_DIR)/io.o $(BUILD_DIR)/timer.o $(BUILD_DIR)/terminal.o $(BUILD_DIR)/util.o $(BUILD_DIR)/assert.o $(BUILD_DIR)/allocator.o
...
$(BUILD_DIR)/allocator.o : $(SRC_DIR)/allocator.c $(SRC_DIR)/allocator.h $(SRC_DIR)/multiboot.h $(SRC_DIR)/assert.h $(SRC_DIR)/terminal.h
